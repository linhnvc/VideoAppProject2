...
class MyChannel: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let cellID = "cellid"
    let imageVideoNames = ["EmGaiMua", "profile_Huong_Tram", "TaConThuocVeNhau", "EmGaiMua"]
    let nameOfVideos = ["Em gai mua", "Ta con thuoc ve nhau", "Huong Tram", "aaa"]
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectLikesVideos.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! MyChannelCell
    ...
    override init(frame: CGRect) {
        ...
        collectLikesVideos.register(MyChannelCell.self, forCellWithReuseIdentifier: cellID)
